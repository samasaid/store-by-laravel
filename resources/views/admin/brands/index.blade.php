                                        ...
                                        <tbody>
                                            @isset($brands)
                                                @foreach ( $brands as $brand )
                                                    ...
                                                    <tr>
                                                        <td>{{ $brand->name }} </td>
                                                        <td><img src="{{ $brand->photo }}" alt="صورة القسم" style="width:150px; height:100px"> </td>
                                                        <td>{{ $brand->getIs_active() }}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{ route('admin.brands.delete' , $brand->id) }}"
                                                                    ...
                                                                    <a href="{{ route('admin.brands.change' , $brand->id) }}"
                                                                    class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">{{ changeStatus($brand) }}</a>
