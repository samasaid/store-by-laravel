                                            ...
                                            @isset($categories)
                                                @foreach ( $categories as $category )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ $category->photo }}" alt="صورة القسم" style="width:150px; height:100px"> </td>
                                                        <td>{{ $category->getIs_active() }}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{ route('admin.mainCategories.delete' , $category->id) }}"
                                                                    ...
                                                                    <a href="{{ route('admin.mainCategories.change' , $category->id) }}"
                                                                    class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">{{ changeStatus($category) }}</a>
