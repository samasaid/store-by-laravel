                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="1" @if($stock->manage_stock == 1) selected @endif>اتاحة التتبع</option>
                                                                    <option value="0" @if($stock->manage_stock == 0 ||$stock->manage_stock == null) selected @endif>عدم اتاحه التتبع</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label="من فضلك أختر  ">
                                                                    <option value="1"@if($stock->in_stock == 1) selected @endif>متاح</option>
                                                                    <option value="0"@if($stock->in_stock == 0) selected @endif>غير متاح </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
