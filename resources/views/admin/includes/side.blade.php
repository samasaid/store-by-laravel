  <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        <li class="nav-item"><a href=""><i class="la la-male"></i>
            ...
            <ul class="menu-content">
            <li class="active"><a class="menu-item" href="{{ route('admin.attributs') }}"
                                  data-i18n="nav.dash.ecommerce"> عرض الكل </a>
            </li>
            <li><a class="menu-item" href="{{ route('admin.attributs.create') }}" data-i18n="nav.dash.crypto">أضافة
                    خاصية جديدة </a>
        </li>
        <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{ __('admin/sidebar.shipping method') }}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{ route('edit-shipping-method' , 'inner') }}">{{ __('admin/sidebar.inner shipping') }}</a>
                            </li>
